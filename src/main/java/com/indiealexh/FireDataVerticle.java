...
public class FireDataVerticle extends AbstractVerticle {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FireDataVerticle.class);
    ...
    public void start(Future<Void> startFuture) {
        ...
        LocalMap<String, JsonObject> fireDataMap = sd.getLocalMap("firedata");
    ...
    private Future<Void> updateDatabase() {
        ...
        downloadXmlFireData()
                ...
                .compose(v -> {
                    ...
                    JsonObject jsonObject = JsonObject.mapFrom(FireData);
                    String json = jsonObject.encode();
                    fireDataMap.put("data", json);
